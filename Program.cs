...
namespace Text_RPG
{
    ...
    public class Item
    {
        ...
        internal class Program
        {
            ...
            {
                _player = new Character("승우", "전사", 1, 10, 5, 100, 1500);
                ...
                AddItem(new Item("청동 도끼", "어디선가 사용됐던거 같은 도끼입니다.", 1, 5, 0, 1500));
                AddItem(new Item("스파르타의 창", "스파르타의 전사들이 사용했다는 전설의 창입니다.", 1, 7, 0, 3000));
                AddItem(new Item("낡은 총", "땅땅땅 빵.", 1, 10, 0, 1000));
                AddItem(new Item("햄씨의 은총", "진짜 총입니다.", 1, 30, 0, 5000));//서브미션
            }
